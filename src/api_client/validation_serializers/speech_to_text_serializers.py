...
class SpeechToTextPostRequest(serializers.Serializer):
    MAXIMAL_MAGIC_BYTES_LENGTH_FOR_ACCEPTED_FILETYPES = 12
    speechFile = serializers.FileField(required=True)

    @classmethod
    def validate_speechFile(cls, speech_file: UploadedFile):  # pylint: disable=C0103

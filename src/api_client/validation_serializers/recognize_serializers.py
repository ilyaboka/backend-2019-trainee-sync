...
class RecognizePostRequest(serializers.Serializer):
    ...
    speechFile: serializers.FileField = serializers.FileField(label='Аудиофайл, содержащий речь для распознования')
...
class RecognizePostResponse(ResponseSerializer):
    recognizedText = serializers.CharField(label='Распознанный текст')
